import { Camera, Plus, X, Eye, Info, UploadCloud, Upload } from 'lucide-react'
import React, { useState, useRef } from 'react'
import { useMutation, useQueryClient } from '@tanstack/react-query'
import { addItem } from '../Services/MenuServices'
...
const AddToMenuForm = () => {
    ...
    const [item, setItem] = useState({ name: "", description: "", price: "", category: "", image: "" })
