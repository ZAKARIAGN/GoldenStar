...
import CardOfitem from '../Components/CardOfitem';
...
const FullMenu = () => {
    ...
    const filterdItems = allItems?.data?.filter((item) => item.name.toLowerCase().includes(search.toLowerCase())) || []

    return (
        <div className='mt-8'>
            <HeaderOfMenu search={search} setSearch={setSearch} />
